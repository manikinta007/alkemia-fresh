...
// --- SUB-COMPONENT: URL INPUT MODAL (Image Injection) ---
    ...
    return (
        <div className="fixed inset-0 z-[200] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in">
            <div className="bg-white rounded-xl shadow-2xl p-6 w-full max-w-md animate-in zoom-in-95">
                <h3 className="text-lg font-bold mb-4">Sisipkan Gambar / Link</h3>
                <input
                    type="text"
                    placeholder="https://..."
                    className="w-full px-4 py-2 border border-zinc-300 rounded-lg mb-4 focus:outline-none focus:border-black"
                    value={url}
                ...
                <div className="flex gap-2">
                    ...
                    <button onClick={() => onConfirm(url)} className="flex-1 py-2 bg-black text-white font-bold rounded-lg hover:bg-zinc-800">OK, Sisipkan</button>
                </div>
            </div>
        </div>
    );
    ...
    return (
        <div className="max-w-6xl mx-auto animate-in fade-in pb-20 w-full px-4 md:px-8 bg-zinc-50 min-h-screen">
            ...
            <div className="flex justify-between items-center mb-6 pt-8">
                <div>
                    <h2 className="text-3xl font-bold tracking-tight text-zinc-900">Editor Soal</h2>
                                ...
                                {headerForm.targetType === 'specific' && (
                                    <div className="pt-2 border-t border-zinc-100">
                                        <div className="flex justify-between items-center mb-1">
                                            ...
                                            <button onClick={() => { setIsIdentityOpen(false); onOpenStudentModal(); }} className="text-[10px] font-bold text-blue-600 underline">Edit Siswa</button>
                                        </div>
